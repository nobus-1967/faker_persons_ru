...
| `--total`, `-t`    | целое число от `1` до `10000`                                       | Количество записей (фейковых персональных данных) в генерируемом массиве. По умолчанию программа генерирует массив из `1000` строк-записей. *При вводе целого числа за пределами* `1-10000` *программа скорректирует его до ближайшего приемлемого значения.* **Если повторить ввод ключа с разными значениями несколько раз, то программа примет последнее заданное значение!**                                                                                                                                                                                  |
